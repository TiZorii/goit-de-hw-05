...
consumer.subscribe(['building_sensors_tet'])
...
try:
    while True:
        ...
        if temperature > 40:
            ...
            producer.produce('temperature_alerts_tet', value=json.dumps(alert).encode('utf-8'), callback=delivery_report)
            producer.poll(1)
        ...
        if humidity > 80 or humidity < 20:
            ...
            producer.produce('humidity_alerts_tet', value=json.dumps(alert).encode('utf-8'), callback=delivery_report)
            producer.poll(1)
